...
| [标签联合体](/zh/patterns/tagged-union/) | Godot | [`variant.h`](https://github.com/godotengine/godot/blob/master/core/variant/variant.h#L78-L120) | `Variant::Type` 枚举 + 联合体——GDScript 中每个值都是 `Variant` |
