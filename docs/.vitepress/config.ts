          ...
          '/patterns/': [
            {
              ...
              items: [
                ...
                { text: 'Merge Iterator (K-Way Merge)', link: '/patterns/merge-iterator/' },
          ...
          '/zh/patterns/': [
            {
              ...
              items: [
                ...
                { text: '归并迭代器 (Merge Iterator)', link: '/zh/patterns/merge-iterator/' },
                { text: 'LSM 树 (LSM Tree)', link: '/zh/patterns/lsm-tree/' },
