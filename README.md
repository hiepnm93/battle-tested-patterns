...
[📖 Tài liệu](https://totoro-jam.github.io/battle-tested-patterns/) · [📖 中文文档](https://totoro-jam.github.io/battle-tested-patterns/zh/)
...
**🧠 Cấu trúc dữ liệu**
- [Bitmask](https://totoro-jam.github.io/battle-tested-patterns/patterns/bitmask/) — nhồi nhiều flag vào một số nguyên
- [Min Heap](https://totoro-jam.github.io/battle-tested-patterns/patterns/min-heap/) — hàng đợi ưu tiên
- [Ring Buffer](https://totoro-jam.github.io/battle-tested-patterns/patterns/ring-buffer/) — FIFO kích thước cố định
- [Trie](https://totoro-jam.github.io/battle-tested-patterns/patterns/trie/) — tìm kiếm theo tiền tố
- [Skip List](https://totoro-jam.github.io/battle-tested-patterns/patterns/skip-list/) — thứ tự theo xác suất
- [Bloom Filter](https://totoro-jam.github.io/battle-tested-patterns/patterns/bloom-filter/) — kiểm tra thành viên tập hợp
- [LRU Cache](https://totoro-jam.github.io/battle-tested-patterns/patterns/lru-cache/) — chính sách loại bỏ
- [B+ Tree](https://totoro-jam.github.io/battle-tested-patterns/patterns/b-plus-tree/) — chỉ mục tối ưu cho đĩa
- [Tagged Union](https://totoro-jam.github.io/battle-tested-patterns/patterns/tagged-union/) — dispatch an toàn kiểu
- [Merkle Tree](https://totoro-jam.github.io/battle-tested-patterns/patterns/merkle-tree/) — bằng chứng toàn vẹn
- [Merge Iterator](https://totoro-jam.github.io/battle-tested-patterns/patterns/merge-iterator/) — gộp k luồng

</td>
<td width="33%">

**⚡ Concurrency**
- [Semaphore](https://totoro-jam.github.io/battle-tested-patterns/patterns/semaphore/) — giới hạn truy cập
- [Actor Model](https://totoro-jam.github.io/battle-tested-patterns/patterns/actor-model/) — truyền thông điệp
- [Work Stealing](https://totoro-jam.github.io/battle-tested-patterns/patterns/work-stealing/) — cân bằng tải
- [MVCC](https://totoro-jam.github.io/battle-tested-patterns/patterns/mvcc/) — cô lập theo snapshot
- [Cooperative Scheduling](https://totoro-jam.github.io/battle-tested-patterns/patterns/cooperative-scheduling/) — nhường quyền điều khiển
- [Double Buffering](https://totoro-jam.github.io/battle-tested-patterns/patterns/double-buffering/) — hoán đổi nguyên tử
- [Backpressure](https://totoro-jam.github.io/battle-tested-patterns/patterns/backpressure/) — kiểm soát luồng
- [Event Loop](https://totoro-jam.github.io/battle-tested-patterns/patterns/event-loop/) — ghép kênh I/O
- [Logical Clock](https://totoro-jam.github.io/battle-tested-patterns/patterns/logical-clock/) — sắp xếp sự kiện

</td>
<td width="33%">

**🏗️ Systems**
- [Circuit Breaker](https://totoro-jam.github.io/battle-tested-patterns/patterns/circuit-breaker/) — chịu lỗi
- [Rate Limiter](https://totoro-jam.github.io/battle-tested-patterns/patterns/rate-limiter/) — điều tiết
- [Retry Backoff](https://totoro-jam.github.io/battle-tested-patterns/patterns/retry-backoff/) — phục hồi
- [Write-Ahead Log](https://totoro-jam.github.io/battle-tested-patterns/patterns/write-ahead-log/) — đảm bảo bền vững
- [Batch Processing](https://totoro-jam.github.io/battle-tested-patterns/patterns/batch-processing/) — tăng throughput
- [Consistent Hashing](https://totoro-jam.github.io/battle-tested-patterns/patterns/consistent-hashing/) — phân tán
- [Dependency Graph](https://totoro-jam.github.io/battle-tested-patterns/patterns/dependency-graph/) — xếp thứ tự
- [Middleware Chain](https://totoro-jam.github.io/battle-tested-patterns/patterns/middleware-chain/) — pipeline
- [Registry](https://totoro-jam.github.io/battle-tested-patterns/patterns/registry/) — tự đăng ký
- [Dirty Flag](https://totoro-jam.github.io/battle-tested-patterns/patterns/dirty-flag/) — hoãn tính toán lại
- [LSM Tree](https://totoro-jam.github.io/battle-tested-patterns/patterns/lsm-tree/) — kho lưu trữ tối ưu ghi
- [Checkpointing](https://totoro-jam.github.io/battle-tested-patterns/patterns/checkpointing/) — khôi phục từ snapshot
...
**♻️ Bộ nhớ**
- [Object Pool](https://totoro-jam.github.io/battle-tested-patterns/patterns/object-pool/) — tái sử dụng instance
- [Flyweight](https://totoro-jam.github.io/battle-tested-patterns/patterns/flyweight/) — chia sẻ đối tượng bất biến
- [Arena Allocator](https://totoro-jam.github.io/battle-tested-patterns/patterns/arena-allocator/) — cấp phát kiểu bump
- [Free List](https://totoro-jam.github.io/battle-tested-patterns/patterns/free-list/) — cấp/giải phóng O(1)
- [Copy-on-Write](https://totoro-jam.github.io/battle-tested-patterns/patterns/copy-on-write/) — hoãn copy
- [Reference Counting](https://totoro-jam.github.io/battle-tested-patterns/patterns/reference-counting/) — tự dọn dẹp
- [Tombstone](https://totoro-jam.github.io/battle-tested-patterns/patterns/tombstone/) — xoá trì hoãn
- [Interning](https://totoro-jam.github.io/battle-tested-patterns/patterns/interning/) — khử trùng lặp giá trị

</td>
<td>

**🔄 Hành vi**
- [State Machine](https://totoro-jam.github.io/battle-tested-patterns/patterns/state-machine/) — chuyển trạng thái
- [Observer](https://totoro-jam.github.io/battle-tested-patterns/patterns/observer/) — pub/sub
- [Iterator](https://totoro-jam.github.io/battle-tested-patterns/patterns/iterator/) — đánh giá lười
- [Diff / Patch](https://totoro-jam.github.io/battle-tested-patterns/patterns/diff-patch/) — chỉnh sửa tối thiểu
- [Vtable](https://totoro-jam.github.io/battle-tested-patterns/patterns/vtable/) — đa hình thủ công
- [Visitor](https://totoro-jam.github.io/battle-tested-patterns/patterns/visitor/) — dispatch khi duyệt cây
...
| [**Flyweight**](https://totoro-jam.github.io/battle-tested-patterns/patterns/flyweight/) | Chia sẻ các đối tượng giống nhau, tránh trùng lặp | [Python int cache](https://github.com/python/cpython/blob/7a014f44c393fda6d1c4bd135608ebcfc21d626c/Objects/longobject.c#L61-L75)|
...
| Hướng dẫn học | [Lộ trình học](https://totoro-jam.github.io/battle-tested-patterns/guide/learning-paths) · [Bảng tra độ phức tạp](https://totoro-jam.github.io/battle-tested-patterns/guide/complexity) · [So sánh pattern](https://totoro-jam.github.io/battle-tested-patterns/guide/pattern-comparison) · [Kế hoạch học](STUDY_PLAN.md) |
...
Xem [Hướng dẫn bài tập](https://totoro-jam.github.io/battle-tested-patterns/guide/exercises) để biết hướng dẫn cài đặt chi tiết cho từng ngôn ngữ.
