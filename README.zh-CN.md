...
[📖 Documentation](https://github.hetsach.com/battle-tested-patterns/) · [📖 中文文档](https://github.hetsach.com/battle-tested-patterns/zh/)
...
**🧠 数据结构**
- [Bitmask](https://github.hetsach.com/battle-tested-patterns/zh/patterns/bitmask/) — 标志位压缩
- [Min Heap](https://github.hetsach.com/battle-tested-patterns/zh/patterns/min-heap/) — 优先队列
- [Ring Buffer](https://github.hetsach.com/battle-tested-patterns/zh/patterns/ring-buffer/) — 定长 FIFO
- [Trie](https://github.hetsach.com/battle-tested-patterns/zh/patterns/trie/) — 前缀搜索
- [Skip List](https://github.hetsach.com/battle-tested-patterns/zh/patterns/skip-list/) — 概率有序
- [Bloom Filter](https://github.hetsach.com/battle-tested-patterns/zh/patterns/bloom-filter/) — 集合判存
- [LRU Cache](https://github.hetsach.com/battle-tested-patterns/zh/patterns/lru-cache/) — 淘汰策略
- [B+ Tree](https://github.hetsach.com/battle-tested-patterns/zh/patterns/b-plus-tree/) — 磁盘优化索引
- [Tagged Union](https://github.hetsach.com/battle-tested-patterns/zh/patterns/tagged-union/) — 类型安全分发
- [Merkle Tree](https://github.hetsach.com/battle-tested-patterns/zh/patterns/merkle-tree/) — 完整性证明
- [Merge Iterator](https://github.hetsach.com/battle-tested-patterns/zh/patterns/merge-iterator/) — K 路合并

</td>
<td width="33%">

**⚡ 并发**
- [Semaphore](https://github.hetsach.com/battle-tested-patterns/zh/patterns/semaphore/) — 有界访问
- [Actor Model](https://github.hetsach.com/battle-tested-patterns/zh/patterns/actor-model/) — 消息传递
- [Work Stealing](https://github.hetsach.com/battle-tested-patterns/zh/patterns/work-stealing/) — 负载均衡
- [MVCC](https://github.hetsach.com/battle-tested-patterns/zh/patterns/mvcc/) — 快照隔离
- [Cooperative Scheduling](https://github.hetsach.com/battle-tested-patterns/zh/patterns/cooperative-scheduling/) — 协作让出
- [Double Buffering](https://github.hetsach.com/battle-tested-patterns/zh/patterns/double-buffering/) — 原子交换
- [Backpressure](https://github.hetsach.com/battle-tested-patterns/zh/patterns/backpressure/) — 流量控制
- [Event Loop](https://github.hetsach.com/battle-tested-patterns/zh/patterns/event-loop/) — I/O 多路复用
- [Logical Clock](https://github.hetsach.com/battle-tested-patterns/zh/patterns/logical-clock/) — 事件排序

</td>
<td width="33%">

**🏗️ 系统**
- [Circuit Breaker](https://github.hetsach.com/battle-tested-patterns/zh/patterns/circuit-breaker/) — 容错
- [Rate Limiter](https://github.hetsach.com/battle-tested-patterns/zh/patterns/rate-limiter/) — 限流
- [Retry Backoff](https://github.hetsach.com/battle-tested-patterns/zh/patterns/retry-backoff/) — 弹性
- [Write-Ahead Log](https://github.hetsach.com/battle-tested-patterns/zh/patterns/write-ahead-log/) — 持久性
- [Batch Processing](https://github.hetsach.com/battle-tested-patterns/zh/patterns/batch-processing/) — 吞吐
- [Consistent Hashing](https://github.hetsach.com/battle-tested-patterns/zh/patterns/consistent-hashing/) — 分布
- [Dependency Graph](https://github.hetsach.com/battle-tested-patterns/zh/patterns/dependency-graph/) — 排序
- [Middleware Chain](https://github.hetsach.com/battle-tested-patterns/zh/patterns/middleware-chain/) — 管道
- [Registry](https://github.hetsach.com/battle-tested-patterns/zh/patterns/registry/) — 自注册
- [Dirty Flag](https://github.hetsach.com/battle-tested-patterns/zh/patterns/dirty-flag/) — 延迟重算
- [LSM Tree](https://github.hetsach.com/battle-tested-patterns/zh/patterns/lsm-tree/) — 写优化存储
- [Checkpointing](https://github.hetsach.com/battle-tested-patterns/zh/patterns/checkpointing/) — 快照恢复
...
**♻️ 内存**
- [Object Pool](https://github.hetsach.com/battle-tested-patterns/zh/patterns/object-pool/) — 复用实例
- [Flyweight](https://github.hetsach.com/battle-tested-patterns/zh/patterns/flyweight/) — 共享不可变
- [Arena Allocator](https://github.hetsach.com/battle-tested-patterns/zh/patterns/arena-allocator/) — bump 分配
- [Free List](https://github.hetsach.com/battle-tested-patterns/zh/patterns/free-list/) — O(1) 分配释放
- [Copy-on-Write](https://github.hetsach.com/battle-tested-patterns/zh/patterns/copy-on-write/) — 延迟复制
- [Reference Counting](https://github.hetsach.com/battle-tested-patterns/zh/patterns/reference-counting/) — 自动清理
- [Tombstone](https://github.hetsach.com/battle-tested-patterns/zh/patterns/tombstone/) — 延迟删除
- [Interning](https://github.hetsach.com/battle-tested-patterns/zh/patterns/interning/) — 去重驻留

</td>
<td>

**🔄 行为型**
- [State Machine](https://github.hetsach.com/battle-tested-patterns/zh/patterns/state-machine/) — 状态转换
- [Observer](https://github.hetsach.com/battle-tested-patterns/zh/patterns/observer/) — 发布订阅
- [Iterator](https://github.hetsach.com/battle-tested-patterns/zh/patterns/iterator/) — 惰性求值
- [Diff / Patch](https://github.hetsach.com/battle-tested-patterns/zh/patterns/diff-patch/) — 最小编辑
- [Vtable](https://github.hetsach.com/battle-tested-patterns/zh/patterns/vtable/) — 手动多态
- [Visitor](https://github.hetsach.com/battle-tested-patterns/zh/patterns/visitor/) — 树遍历分发
...
| 双语 | 完整中英文文档 |
| 学习指南 | [学习路径](https://github.hetsach.com/battle-tested-patterns/zh/guide/learning-paths) · [复杂度速查表](https://github.hetsach.com/battle-tested-patterns/zh/guide/complexity) · [模式对比](https://github.hetsach.com/battle-tested-patterns/zh/guide/pattern-comparison) · [学习计划](STUDY_PLAN.md) |
...
各语言详细设置请参考[练习指南](https://github.hetsach.com/battle-tested-patterns/zh/guide/exercises)。
