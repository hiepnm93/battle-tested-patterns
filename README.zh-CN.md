...
| [**事件循环**](https://totoro-jam.github.io/battle-tested-patterns/zh/patterns/event-loop/) | 单线程循环通过 epoll/kqueue 复用 I/O | [libuv](https://github.com/libuv/libuv/blob/v1.x/src/unix/core.c#L427-L492) · [Redis ae](https://github.com/redis/redis/blob/unstable/src/ae.c#L360-L468)|
...
| [**B+ 树**](https://totoro-jam.github.io/battle-tested-patterns/zh/patterns/b-plus-tree/) | 高扇出平衡树——内部节点引导，叶节点存储并链接用于范围扫描 | [PostgreSQL](https://github.com/postgres/postgres/blob/master/src/backend/access/nbtree/nbtinsert.c#L22-L55) · [SQLite](https://github.com/sqlite/sqlite/blob/master/src/btreeInt.h#L190-L198)|
...
| [**逻辑时钟**](https://totoro-jam.github.io/battle-tested-patterns/zh/patterns/logical-clock/) | 单调递增计数器，无需物理时钟即可排序事件 | [etcd](https://github.com/etcd-io/etcd/blob/main/server/storage/mvcc/kvstore.go#L53-L72) · [LevelDB](https://github.com/google/leveldb/blob/main/db/dbformat.h#L62-L66)|
...
| [**引用计数**](https://totoro-jam.github.io/battle-tested-patterns/zh/patterns/reference-counting/) | 原子计数器追踪所有者，归零时自动清理 | [CPython](https://github.com/python/cpython/blob/main/Include/refcount.h#L255-L310) · [Rust Arc](https://github.com/rust-lang/rust/blob/master/library/alloc/src/sync.rs#L269-L276)|
| [**注册表**](https://totoro-jam.github.io/battle-tested-patterns/zh/patterns/registry/) | 组件按名自注册到全局查找表 | [TensorFlow](https://github.com/tensorflow/tensorflow/blob/master/tensorflow/core/framework/op.h#L258-L290) · [gRPC-Go](https://github.com/grpc/grpc-go/blob/master/server.go#L154-L170)|
...
| [**脏标志**](https://totoro-jam.github.io/battle-tested-patterns/zh/patterns/dirty-flag/) | 变更时标记"脏"，延迟重计算直到需要时 | [Chromium/Blink](https://github.com/chromium/chromium/blob/main/third_party/blink/renderer/core/layout/layout_object.h#L1425-L1430) · [React](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberFlags.js#L18-L22)|
...
| [**中间件链**](https://totoro-jam.github.io/battle-tested-patterns/zh/patterns/middleware-chain/) | 组合处理器，每个包装下一个——双向管道 | [gRPC-Go](https://github.com/grpc/grpc-go/blob/master/server.go#L1224-L1260) · [Koa.js](https://github.com/koajs/koa/blob/master/lib/application.js#L152-L204)|
...
| [**墓碑删除**](https://totoro-jam.github.io/battle-tested-patterns/zh/patterns/tombstone/) | 标记删除而非物理删除，后台回收空间 | [LevelDB](https://github.com/google/leveldb/blob/main/db/dbformat.h#L39-L43) · [Cassandra](https://github.com/apache/cassandra/blob/trunk/src/java/org/apache/cassandra/db/DeletionTime.java#L37-L99)|
